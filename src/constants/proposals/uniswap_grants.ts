...
The UGP will be funded by the UNI treasury according to the[ release schedule](https://levinswap.realt.community/blog/uni/) set out by the Uniswap team, whereby 43% of the UNI treasury is released over a four-year timeline. In Year 1 this will total to 172,000,000 UNI (~$344M as of writing).
