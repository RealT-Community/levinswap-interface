    ...
    <HeaderFrame>
      ...
      <HeaderControls>
        <HeaderElement>
          ...
          <LevinToken onClick={() => window.open('https://farm.levinswap.realtoken.community', '_blank')}>
            <span role="img" aria-label="farm">
              🌾
            </span>{' '}
            Farm
          </LevinToken>
          <LevinToken onClick={() => window.open('https://stake.levinswap.realtoken.community', '_blank')}>
